                ...
                if (this.workspaceRoot && this.pathExists(path.join(this.workspaceRoot, 'node_modules', moduleName))) {
                    ...
                    if (this.pathExists(modulePackageJsonPath)) {
                        ...
                        if (modulePackageJson.version) {
                            ...
                            if (!isSatisfied) {
                                this.nonExistingModules.push(new ModuleInfo(moduleName, version));
                            }
                        }
                    }
                    ...
                    this.unSatisfiedModules.push(new ModuleInfo(moduleName, version));
    ...
    getChildren(element?: any): vscode.ProviderResult<Dependency[]> {
        if (element) {
            ...
            if (this._packageJsonPath) {
                return Promise.resolve(this.getPackages(this._packageJsonPath));
            }
        }
    }
